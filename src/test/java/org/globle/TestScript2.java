...
public class TestScript2 extends BaseClass1 {
	public static void main(String[] args) throws IOException {
		...
		baseClass1.getDriver(baseClass1.readExcel(2,3 ));
		baseClass1.getUrl(baseClass1.readExcel(2, 4));
		...
		baseClass1.selectByVisibleText(creditCardType, baseClass1.readExcel(2, 19));
